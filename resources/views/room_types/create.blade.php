                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="base_price" name="base_price" value="{{ old('base_price') }}" step="0.01" min="0" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="text-muted">Upload an image of this room type (optional)</small>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="has_air_conditioning" name="has_air_conditioning" {{ old('has_air_conditioning') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="has_tv" name="has_tv" {{ old('has_tv') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="has_refrigerator" name="has_refrigerator" {{ old('has_refrigerator') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="has_safe" name="has_safe" {{ old('has_safe') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="has_wifi" name="has_wifi" {{ old('has_wifi') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="has_minibar" name="has_minibar" {{ old('has_minibar') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="has_bathtub" name="has_bathtub" {{ old('has_bathtub') ? 'checked' : '' }}>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Add existing amenities if any (from old input)
        @if(old('amenities'))
